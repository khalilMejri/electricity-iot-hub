# Meter Data Management System node publisher/subscriber
...
print(
    'Publishing a new message every {0} seconds (press Ctrl-C to quit)...'.format(feed_price_freq))
set_interval(client, feed_price_id, feed_price_freq)

print(
    'Publishing a new message every {0} seconds (press Ctrl-C to quit)...'.format(feed_voltage_freq))
set_interval(client, feed_voltage_id, feed_voltage_freq)
